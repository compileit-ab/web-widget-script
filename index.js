...
let imgSrc= ""
if(language !== "en") {
  imgSrc =`https://res.cloudinary.com/barncancerfonden/image/upload/BCF-widget/companies-big-data/${companyName.toLowerCase()}/barncancerfonden-widget?date=${date}`
} else{
  imgSrc =`https://res.cloudinary.com/barncancerfonden/image/upload/BCF-widget/companies-big-data/${companyName.toLowerCase()}/barncancerfonden-widget-en?date=${date}`
}
